...
namespace projem
{
    public partial class frmDedemanMusteriler : Form
    {
        public frmDedemanMusteriler()
        {
            InitializeComponent();
        }
        ...
        private void frmDedemanMusteriler_Load(object sender, EventArgs e)
        {
            ...
            if (rd.HasRows) // Girilen K.Adı ve K.Parola Dahilinde Gelen Data var ise 
            {
                ...
                {
                    dataGridView2.Rows.Add(rd["DedemanMusteriID"].ToString(), rd["TC"].ToString(), rd["Ad"].ToString(), rd["Soyad"].ToString(), rd["BabaAdi"].ToString(), rd["AnneAdi"].ToString(), rd["DogumTarihi"].ToString(), rd["Cinsiyet"].ToString(), rd["MedeniHali"].ToString());
                }
            }
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection cnn = new SqlConnection("server =.; Initial Catalog = OtelProje; Integrated Security = SSPI");
                SqlCommand cmd = new SqlCommand("delete from DedemanMusteriBilgileri where DedemanMusteriID=@ID", cnn);
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            Form frm = new frmDedemanGuncelle();
            frm.Show();
        }
        ...
        {
            Form frmGit = new frmDedemanRezervasyonİslemleri();
            frmGit.Show();
        }
                ...
                while (iRow <= dataGridView2.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (bNewPage)
                        {
                            ...
                            e.Graphics.DrawString("Dedeman Otel Müşteriler", new Font(dataGridView2.Font, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top -
                                    e.Graphics.MeasureString("Dedeman Otel Müşteriler", new Font(dataGridView2.Font,
                            ...
                            e.Graphics.DrawString(strDate, new Font(dataGridView2.Font, FontStyle.Bold),
                                    ...
                                    e.Graphics.MeasureString("Dedeman Otel Müşteriler", new Font(new Font(dataGridView2.Font,
        ...
        {
            Form frm = new frmDedemanMusteriler();
            frm.Show();
            this.Hide();
        }
    }

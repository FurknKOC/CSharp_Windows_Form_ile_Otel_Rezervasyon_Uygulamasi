...
namespace projem
{
    public partial class frmKutberkMusteriler : Form
    {
        public frmKutberkMusteriler()
        {
            InitializeComponent();
        }
        ...
        private void frmKutberkMusteriler_Load(object sender, EventArgs e)
        {
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            SqlConnection cnn = new SqlConnection("server =.; Initial Catalog = OtelProje; Integrated Security = SSPI");
            SqlCommand cmd = new SqlCommand("select * from KutberkMusteriBilgileri", cnn);
            cmd.Connection.Open();
            ...
            if (rd.HasRows) // Girilen K.Adı ve K.Parola Dahilinde Gelen Data var ise 
            {
                ...
                {
                    dataGridView2.Rows.Add(rd["KutberkMusteriID"].ToString(), rd["TC"].ToString(), rd["Ad"].ToString(), rd["Soyad"].ToString(), rd["BabaAdi"].ToString(), rd["AnneAdi"].ToString(), rd["DogumTarihi"].ToString(), rd["Cinsiyet"].ToString(), rd["MedeniHali"].ToString());
                }
            }
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection cnn = new SqlConnection("server =.; Initial Catalog = OtelProje; Integrated Security = SSPI");
                SqlCommand cmd = new SqlCommand("delete from KutberkMusteriBilgileri where KutberkMusteriID=@ID", cnn);
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            Form frm = new frmKutberkGuncelle();
            frm.Show();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            Form frmKutberkMusteriler = new frmKutberkMusteriler();
            frmKutberkMusteriler.Show();
            this.Hide();
        }

        private void MusteriKaydet_Click(object sender, EventArgs e)
        {
            Form frmGit = new frmKutberkRezervasyonIslemleri();
            frmGit.Show();
                ...
                while (iRow <= dataGridView2.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (bNewPage)
                        {
                            ...
                            e.Graphics.DrawString("Kutberk Butik Otel Müşteriler", new Font(dataGridView2.Font, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top -
                                    e.Graphics.MeasureString("Kutberk Butik Otel Müşteriler", new Font(dataGridView2.Font,
                            ...
                            e.Graphics.DrawString(strDate, new Font(dataGridView2.Font, FontStyle.Bold),
                                    ...
                                    e.Graphics.MeasureString("Kutberk Butik Otel Müşteriler", new Font(new Font(dataGridView2.Font,

...
namespace projem
{
    public partial class frmEceSarayMusteriler : Form
    {
        public frmEceSarayMusteriler()
        {
            InitializeComponent();
        }
        ...
        private void frmEceSarayMusteriler_Load(object sender, EventArgs e)
        {
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            SqlConnection cnn = new SqlConnection("server =.; Initial Catalog = OtelProje; Integrated Security = SSPI");
            SqlCommand cmd = new SqlCommand("select * from EceSarayMusteriBilgileri", cnn);
            cmd.Connection.Open();
            ...
            if (rd.HasRows) // Girilen K.Adı ve K.Parola Dahilinde Gelen Data var ise 
            {
                ...
                {
                    dataGridView2.Rows.Add(rd["EceSarayMusteriID"].ToString(), rd["TC"].ToString(), rd["Ad"].ToString(), rd["Soyad"].ToString(), rd["BabaAdi"].ToString(), rd["AnneAdi"].ToString(), rd["DogumTarihi"].ToString(), rd["Cinsiyet"].ToString(), rd["MedeniHali"].ToString());
                }
            }
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection cnn = new SqlConnection("server =.; Initial Catalog = OtelProje; Integrated Security = SSPI");
                SqlCommand cmd = new SqlCommand("delete from EceSarayMusteriBilgileri where EceSarayMusteriID=@ID", cnn);
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            Form frm = new frmEceSarayGuncelle();
            frm.Show();
        }
        ...
        {
            Form frmGit = new frmEceSarayRezervasyonIslemleri();
            frmGit.Show();
        }
                ...
                while (iRow <= dataGridView2.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (bNewPage)
                        {
                            ...
                            e.Graphics.DrawString("EceSaray Otel Müşteriler", new Font(dataGridView2.Font, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top -
                                    e.Graphics.MeasureString("EceSaray Otel Müşteriler", new Font(dataGridView2.Font,
                            ...
                            e.Graphics.DrawString(strDate, new Font(dataGridView2.Font, FontStyle.Bold),
                                    ...
                                    e.Graphics.MeasureString("EceSaray Otel Müşteriler", new Font(new Font(dataGridView2.Font,
        ...
        {
            Form frm = new frmEceSarayMusteriler();
            frm.Show();
            this.Hide();
        }
    }

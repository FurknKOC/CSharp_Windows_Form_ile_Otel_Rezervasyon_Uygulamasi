...
namespace projem
{
    public partial class frmAntalyaSuRezervasyon : Form
    {
        public frmAntalyaSuRezervasyon()
        {
            InitializeComponent();
        }

        private void frmAntalyaSuRezervasyon_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            odanumarasi = 1;
            odafiyat = 100;
            Form AntalyaSuRezervasyonIslemleri = new frmAntalyaSuRezervasyonIslemleri();
            AntalyaSuRezervasyonIslemleri.Show();

...
namespace projem
{
    public partial class frmKutberkRezervasyon : Form
    {
        public frmKutberkRezervasyon()
        {
            InitializeComponent();
        }

        private void frmKutberkRezervasyon_Load(object sender, EventArgs e)
        {
        ...
        {
            odanumarasi = 1;
            Form KutberkRezervasyonIslemleri = new frmKutberkRezervasyonIslemleri();
            KutberkRezervasyonIslemleri.Show();

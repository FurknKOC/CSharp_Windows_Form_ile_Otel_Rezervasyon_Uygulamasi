...
namespace projem
{
    public partial class frmKutberkRezervasyonIslemleri : Form
    {
        public frmKutberkRezervasyonIslemleri()
        {
            InitializeComponent();
        }
        ...
        private void frmKutberkRezervasyonIslemleri_Load(object sender, EventArgs e)
        {
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            SqlConnection cnn = new SqlConnection("server =.; Initial Catalog = OtelProje; Integrated Security = SSPI");
            SqlCommand cmd = new SqlCommand("select * from KutberkOdaDurum  where KutberkOdaDurum.KutberkOdaID=@IDler ", cnn);
            cmd.Parameters.AddWithValue("@IDler", frmKutberkRezervasyon.odanumarasi);
            cmd.Connection.Open();
